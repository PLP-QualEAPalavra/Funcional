...
/* package Funcional-0.1.0.0 */
#ifndef VERSION_Funcional
#define VERSION_Funcional "0.1.0.0"
#endif /* VERSION_Funcional */
#ifndef MIN_VERSION_Funcional
#define MIN_VERSION_Funcional(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Funcional */
...
#define CURRENT_COMPONENT_ID "Funcional-0.1.0.0-inplace-Funcional"
